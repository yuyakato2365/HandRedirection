    ...
    fig.update_layout(
        updatemenus=[
            dict(
                type="buttons",
                buttons=[
                    dict(label="Play", method="animate", args=[None, {"frame": {"duration": 60, "redraw": False}, "fromcurrent": True}]),
        ...
        sliders=[
            dict(
                steps=[
                    dict(method="animate", args=[[frame.name], {"mode": "immediate", "frame": {"duration": 0, "redraw": False}}], label=frame.name)
                    for frame in frames
                ]
            )
        ],
    ...
    fig.update_layout(
        ...
        updatemenus=[
            dict(
                type="buttons",
                buttons=[
                    dict(label="Play", method="animate", args=[None, {"frame": {"duration": 70, "redraw": False}, "fromcurrent": True}]),
                    dict(label="Pause", method="animate", args=[[None], {"frame": {"duration": 0, "redraw": False}, "mode": "immediate"}]),
                ],
            )
        ],
    ...
    fig.update_layout(
            ...
            dict(
                ...
                buttons=[
                    dict(
                        label="Play",
                        method="animate",
                        args=[None, {"frame": {"duration": 70, "redraw": False}, "transition": {"duration": 0}, "fromcurrent": True}],
                    ),
                    dict(label="Pause", method="animate", args=[[None], {"frame": {"duration": 0, "redraw": False}, "mode": "immediate"}]),
                ],
            )
        ...
        sliders=[
            dict(
                ...
                pad={"t": 35},
                steps=[
                    dict(method="animate", args=[[frame.name], {"mode": "immediate", "frame": {"duration": 0, "redraw": False}, "transition": {"duration": 0}}], label=frame.name)
                    for frame in frames
                ],
            )
        ],
