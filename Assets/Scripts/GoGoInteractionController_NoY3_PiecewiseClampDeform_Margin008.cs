...
/// </summary>
public class GoGoInteractionController_NoY4 : MonoBehaviour
{
    ...
    [Tooltip("側面範囲（=内側で n 倍が効く範囲）を外側に拡張するマージン[m]。例: 0.08 で境界を +8cm")]
    public float sideRangeMargin = 0.08f;
    ...
    float ComputeBlendDistance(Vector3 deltaRealLocal, Vector3 ratio)
    {
        ...
        // surface distance to deformed box: halfExtents' = (baseHalfExtents + sideRangeMargin) * ratio
